              ...
              <div className="md:w-1/2">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white p-6 rounded-2xl border border-border shadow-sm text-center mt-8">
                    <div className="text-4xl font-heading text-pop-1 mb-2">10+</div>
                    <div className="text-sm text-foreground/60 font-medium">Years of Legacy</div>
                  </div>
                  <div className="bg-white p-6 rounded-2xl border border-border shadow-sm text-center -mt-4">
                    <div className="text-4xl font-heading text-pop-2 mb-2">NID/IIT</div>
                    <div className="text-sm text-foreground/60 font-medium">Mentor Network</div>
                  </div>
                  <div className="bg-white p-6 rounded-2xl border border-border shadow-sm text-center mt-4">
                    <div className="text-4xl font-heading text-pop-3 mb-2">100%</div>
                    <div className="text-sm text-foreground/60 font-medium">Community Driven</div>
                  </div>
                </div>
              </div>
              <div className="md:w-1/2">
